            ...
            <ul className="text-xl text-gray-600">
              <li className="flex items-center mb-2">
                ...
                <span className="flex text-xl font-bold">
                  Email: <p className="ml-2">aryan.jaiswal0602@gmail.com</p>
                </span>
              </li>
              <li className="flex items-center mb-2">
                <CiMobile3 className="mr-2" />
                <span className="flex font-bold">
                  Phone: <p className="ml-2">6203496584</p>
                </span>
              </li>
              <li className="flex items-center mb-2">
                ...
                <span className="flex font-bold">
                  ...
                  <p className="ml-2">
                    ...
                    >
                      https://www.linkedin.com/in/aryan-jaiswal-9a609a228/
                    </a>
                  </p>
                </span>
              </li>
